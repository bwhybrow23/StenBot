            ...
            switch (galleryaction) {
                case "info":
                    ...
                    if (accountexists == false) {
                        return message.channel.send({
                            embed: {
                                color: bot.settings.red,
                                description: `Please create a StenBot Account first!`
                            }
                        });
                    };
                ...
                case "upload":
                    ...
                    if (message.attachments.array().length < 1) {
                        return message.channel.send({
                            embed: {
                                color: bot.settings.red,
                                description: `Make sure you attach a file to this command!`
                            }
                        });
                    };
                    ...
                    if (message.attachments.array().length > 1) {
                        return message.channel.send({
                            embed: {
                                color: bot.settings.red,
                                description: `Only upload 1 file at a time! Please make sure there is only 1 attachment!`
                            }
                        });
                    };
                    ...
                    if ((accountconfiguration.galleryused + 1) > accountconfiguration.gallerycap) {
                        return message.channel.send({
                            embed: {
                                color: bot.settings.red,
                                description: `You have reached your gallery cap. Consider donating to support development to raise the cap.`
                            }
                        });
                    };
                    ...
                    if (picalias.length < 1) {
                        return message.channel.send({
                            embed: {
                                color: bot.settings.red,
                                description: `Please include a name for the photo.`
                            }
                        });
                    };
                    if (picalias.length > 16) {
                        return message.channel.send({
                            embed: {
                                color: bot.settings.red,
                                description: `The name is above 16 characters.`
                            }
                        });
                    };
                    ...
                    if (isValid == false) {
                        return message.channel.send({
                            embed: {
                                color: bot.settings.red,
                                description: `The name can only inclued numbers and letters.`
                            }
                        })
                    };
                    ...
                    if (message.attachments.array()[0].filesize > 2000000) {
                        return message.channel.send({
                            embed: {
                                color: bot.settings.red,
                                description: `The file is larger than 2MB in size!`
                            }
                        });
                    };
                    ...
                    if (fs.existsSync(`./data/galleries/${message.author.id}/${picalias}.${picextension}`) == true) {
                        return message.channel.send({
                            embed: {
                                color: bot.settings.red,
                                description: `You already have a file with that filename in your gallery!`
                            }
                        });
                    };
                    ...
                    message.channel.send({
                        embed: {
                            color: bot.settings.green,
                            description: `Sucessfully uploaded image to gallery.`
                        }
                    });
                    break;
                ...
                default:
                    message.channel.send({
                        embed: {
                            color: bot.settings.red,
                            description: `There is no gallery action called ${galleryaction}`
                        }
                    })
                    break;
            };
