module.exports = {
    ...
    let braveEmbed = new Discord.RichEmbed()
     ...
     .setDescription("Brave is a browser focused around creating a safer and faster internet. With its built in ad-blocker, own rewards program and it's Chromium back end, why not check it out. It's free! Download it for 30 days and if you don't like it, then just uninstall it!")
