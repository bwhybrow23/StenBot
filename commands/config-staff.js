exports.run = (bot, message, args) => {
    ...
    switch (setting) {
        ...
        case "filteradd":
          ...
          message.channel.send({embed: {color: bot.settings.green, description: `The word **${word}** has been added to the filter!`}});
        ...
        case "filterremove":
          ...
          fs.writeFileSync(`./data/servers/server-${message.guild.id}/serverconfig.json`, JSON.stringify(config, null, 4), (err) => {
            ...
            message.channel.send({embed: {color: bot.settings.green, description: `The word **${word}** has been removed from the filter!`}});
