  ...
  run: async (bot, message, args) => {
    ...
    if (subc === "help") {
      let embed = new Discord.RichEmbed()
        ...
        .addField(
          "`sb!action hug @user`",
          "Hug someone and make them feel happy."
        )
        .addField("`sb!action kiss @user`", "Give that special person a kiss.")
        .addField("`sb!action pat @user`", "Pat someone for being a good dog.")
        .addField(
          "`sb!action poke @user`",
          "Back to the good ol' days of poking people."
        )
        .addField(
          "`sb!action slap @user`",
          "Slap someone just for the sake of it."
        )
        .addField(
          "`sb!action tickle @user`",
          "Tickle someone just to make them annoyed."
        )
      ...
      if (!subc) {
        let embed = new Discord.RichEmbed()
          ...
          .setColor(bot.settings.color.blue)
          .addField(
            "`sb!action cuddle @user`",
            "Cuddle someone you really like."
          )
          .addField(
            "`sb!action hug @user`",
            "Hug someone and make them feel happy."
          ...
          .addField(
            "`sb!action kiss @user`",
            "Give that special person a kiss."
          )
          .addField(
            "`sb!action pat @user`",
            "Pat someone for being a good dog."
          )
          .addField(
            "`sb!action poke @user`",
            "Back to the good ol' days of poking people."
