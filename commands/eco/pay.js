exports.run = async (bot, message, args) => {
    ...
    if (member < amount) {
        return message.reply(`That's more money than you've got in your balance.`)
    }

    message.channel.send(`${message.author.tag}, You successfully paid ${user.username} ${args[1]} coins.`)
